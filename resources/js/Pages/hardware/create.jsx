...
export default function CreateHardware({ errors,sensors }) {
    ...
    const storeHardware = async (e) => {
        e.preventDefault();
        
        Inertia.post('/hardware', {
            hardware: hardware,
            location: location,
            latitude: latitude,
            longitude: longitude,
                ...
                <div className="col-12">
                    <div className="card border-0 rounded shadow-sm border-top-success">
                        <div className="card-header">
                            <span className="font-weight-bold">TAMBAH HARDWARE</span>
                        </div>
                        <div className="card-body">
                            <form onSubmit={storeHardware}>
