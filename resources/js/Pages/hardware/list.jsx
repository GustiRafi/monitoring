...
export default function HardwareIndex({ hardwares, session = { success: null }  }) {
    ...
    const deleteHardware = async (hardwares) => {
        Inertia.delete(`/hardware/${hardwares}`);
    }
  ...
  return (
    <Layout>
        <div style={{ marginTop: '100px' }}>
            ...
            <Link href="/hardware/create" className="btn btn-success btn-md mb-3">TAMBAH Hardware</Link>
                        ...
                        { hardwares.map((hardware, index) => (
                            <tr key={ index }>
                                ...
                                <td className="text-center">
                                    ...
                                    <button onClick={() => deleteHardware(hardware.id)} className="btn btn-sm btn-danger">DELETE</button>
                                 </td>
                            </tr>
                        )) }
                        </tbody>
